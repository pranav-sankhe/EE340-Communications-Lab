...
# Title: Single Sideband Upconversion
# Generated: Thu Jul 27 02:26:23 2017
##################################################
...
class Single_sideband_upConversion(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Single Sideband Upconversion")
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 10000, 1, 0)
...
if __name__ == '__main__':
    ...
    tb = Single_sideband_upConversion()
    tb.Start(True)
    tb.Wait()
