...
# Title: Top Block
# Generated: Fri Aug  4 16:31:21 2017
##################################################
...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.lab2_part4 = self.lab2_part4 = wx.Notebook(self.GetWin(), style=wx.NB_TOP)
        ...
        self.iir_filter_ffd_0 = filter.iir_filter_ffd((1/960e3, ), (1,1), True)
        ...
        self.connect((self.iir_filter_ffd_0, 0), (self.analog_phase_modulator_fc_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.wxgui_fftsink2_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.iir_filter_ffd_0, 0))
